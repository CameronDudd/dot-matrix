...
const Font simpleFont = {
    ...
    .map =
        {
            0b0111111111111111,  // UNSUPPORTED
            ...
            0b0101101101111101,  // W
            0b0101101010101101,  // X
            0b0101101011001110,  // Y
            ...
            0b0100010000000000,  // `
            0b0000000011101011,  // a
            0b0100100110101110,  // b
            0b0000000011100011,  // c
            0b0001001011101011,  // d
            0b0000011011100010,  // e
            0b0000010100110100,  // f
            0b0000110110001010,  // g
            0b0100100110101101,  // h
            0b0000010000010010,  // i
            0b0001000001101010,  // j
            0b0100100101110101,  // k
            0b0100100100101010,  // l
            0b0000101111101101,  // m
            0b0000000110101101,  // n
            0b0000010101101010,  // o
            0b0000010101110100,  // p
            0b0000010101011001,  // q
            0b0000100111100100,  // r
            0b0000010100010100,  // s
            0b0000100110100110,  // t
            0b0000000101101111,  // u
            0b0000000101101010,  // v
            0b0000101101111101,  // w
            0b0000000101010101,  // x
            0b0000000101010100,  // y
            0b0000100010100010,  // z
            0b0011010110010011,  // {
            0b0010010010010010,  // |
            0b0110010011010110,  // }
            0b1000000000000000,  // ~
